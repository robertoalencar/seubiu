...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_suggestion_Suggestion_vue__ = __webpack_require__(40);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_home_Home_vue__ = __webpack_require__(36);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_login_Login_vue__ = __webpack_require__(7);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_register_RegisterProfessional_vue__ = __webpack_require__(8);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_list_ListProfessional_vue__ = __webpack_require__(37);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_login_Login_vue__ = __webpack_require__(7);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__register_RegisterProfessional_vue__ = __webpack_require__(8);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    data() {
        return {
            ...
            approve: true,
            pickUser: {},
            people: { 'name': 'everton', 'cpf': '3222', 'rg': '2312312' }
        };
    },

    created() {

        this.$http.get('http://localhost:3000/api/users', { headers: { 'Authorization': this.$store.state.token } }).then(res => res.json()).then(result => this.users = result, err => console.log(err));
    },
    ...
    methods: {
        ...
        logInto() {
            ...
            if (reg.test(this.email) === false) {
                ...
                this.$http.post('http://localhost:3000/api/authenticate', user).then(res => res.json()).then(function (res) {

                    var jwt = 'JWT ';

                    this.$store.state.token = jwt + res.token;
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    created() {
        ...
        this.$http.get('http://localhost:3000/api/professions', { 'Authorization': this.$store.state.token }).then(res => res.json()).then(resultado => this.professions = resultado, err => console.log(err));
    },
    ...
    methods: {
        ...
        listServices() {
            ...
            if (this.professionSelecteds.length > 0) {
                ...
                this.professionSelecteds.forEach(profession => {
                    ...
                    this.$http.get('http://localhost:3000/api/professions/' + profession.id + '/services', { headers: { 'Authorization': this.$store.state.token } }).then(res => res.json()).then(result => {
                        if (result.length > 0) {
                            result.forEach(r => {
        ...
        send() {
            ...
            if (this.name != '' && this.cpf != '' && this.rg != '' && this.date != '' && this.selectedProfession != '' && this.certificates != '' && this.numberWorkPermit != '' && this.yearInProfession != '') {
                ...
                alert("Envie os dados: " + this.name + this.email + this.cpf + this.rg + this.date + this.selectedProfession + this.certificates + this.numberWorkPermit + this.yearInProfession);
            } else {
  ...
  methods: {
    ...
    saveServices() {
      ...
      if (this.services.length > 0) {
        ...
        this.$http.post('http://localhost:3000/api/professionsuggestions/' + this.suggestion.id + '/approve', {}, { headers: { 'Authorization': this.$store.state.token } }).then(() => console.log("Sugestão aprovada com sucesso"), err => console.log(JSON.stringify(err)));
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__servicemodal_ServiceModal_vue__ = __webpack_require__(38);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vuejs_paginator__ = __webpack_require__(60);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    created() {
        ...
        this.$http.get('http://localhost:3000/api/groupedprofessionsuggestions/', { headers: { 'Authorization': this.$store.state.token } }).then(res => res.json()).then(result => this.suggestions = result, err => console.log(err));
    },
    ...
    methods: {
        ...
        disapproveSuggestion(suggestionId, index) {
            ...
            this.$http.delete('http://localhost:3000/api/professionsuggestions/' + suggestionId, { headers: { 'Authorization': this.$store.state.token } }).then(() => this.suggestionWithFilter.splice(index, 1), err => console.log(err));
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__shared_sidebar_Sidebar_vue__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__shared_sidebar_Sidebar_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__shared_sidebar_Sidebar_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__shared_table_Table_vue__ = __webpack_require__(39);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_vee_validate__ = __webpack_require__(11);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__pt_BR__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_vuejs_paginate__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_vuejs_paginate___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_7_vuejs_paginate__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__store__ = __webpack_require__(10);
...
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.use(__WEBPACK_IMPORTED_MODULE_7_vuejs_paginate___default.a);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
  ...
  }, [_vm._v(" " + _vm._s(_vm.errors.first('name')) + " ")]), _vm._v(" "), _c('br'), _vm._v(" "), _c('transition', {
    attrs: {
      "name": "spanInput"
    }
  }, [_c('span', {
    ...
    staticClass: "form-control",
    attrs: {
      "data-vv-rules": "required|regex:(\\w[.-]*)+@\\w+.com$",
      "name": "email",
      "type": "text",
    ...
    staticClass: "errorValidate"
  }, [_vm._v(" " + _vm._s(_vm.errors.first('email')) + " ")]), _vm._v(" "), _c('br'), _vm._v(" "), _c('transition', {
    attrs: {
      "name": "spanInput"
    }
  }, [_c('span', {
    ...
    staticClass: "spanInput"
  }, [_vm._v("Certificados")])]), _vm._v(" "), _c('input', {
    directives: [{
      name: "validate",
      rawName: "v-validate"
    }, {
    ...
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.certificates = $event.target.value
      }
    }
  }), _vm._v(" "), _c('span', {
    directives: [{
      name: "show",
      rawName: "v-show",
      value: (_vm.errors.has('certificates')),
      expression: "errors.has('certificates')"
    }],
    staticClass: "errorValidate"
  }, [_vm._v(" " + _vm._s(_vm.errors.first('certificates')) + " ")])], 1), _vm._v(" "), _c('div', {
    staticClass: "col-md-12",
    staticStyle: {
      "padding-top": "5px"
    }
    ...
    attrs: {
      "type": "text",
      "placeholder": "Carteira de identidade(RG)",
      "required": ""
    }
  ...
  }, [_c('strong', [_vm._v(" Dados Profissionais: ")]), _c('br'), _c('br'), _vm._v(" "), _c('strong', [_vm._v("Profissão:")]), _vm._v("  " + _vm._s(_vm.selectedProfession)), _c('br'), _vm._v(" "), _c('strong', [_vm._v("Certificados:")]), _vm._v(_vm._s(_vm.certificates) + " "), _c('br'), _vm._v(" "), _c('strong', [_vm._v("Carteira de trabalho:")]), _vm._v(_vm._s(_vm.numberWorkPermit)), _c('br'), _vm._v(" "), _c('strong', [_vm._v("Anos de Experiência:")]), _vm._v(" " + _vm._s(_vm.yearInProfession) + " "), _c('br')]), _vm._v(" "), _c('div', {
    staticClass: "buttons"
  }, [_c('form', {
    on: {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
  ...
  }, [_c('span', [_vm._v("Sugestão reprovada com sucesso")])]), _vm._v(" "), _c('div', {
    directives: [{
      name: "show",
      rawName: "v-show",
      value: (_vm.approve),
    ...
    staticClass: "messageReprove"
  }, [_c('span', [_vm._v("Sugestão aprovada com sucesso")])]), _vm._v(" "), _c('div', {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_vm._m(1), _vm._v(" "), _vm._l((_vm.usersWithFilter), function(user) {
  ...
  return _c('thead', [_c('tr', {
    staticClass: "trCollor"
  }, [_c('th', [_vm._v("Usuário")]), _vm._v(" "), _c('th', [_vm._v("Status")])])])
}]}
